...
export const personas: DemoPersona[] = [
  {
    id: "citizen-meena", firstName: "Meena", name: "Meena Iyer", age: 61, language: "en", persona: "fresh-victim", email: "meena@demo.in", password: "demo1234", accessCode: "meena@demo.in / demo1234", destination: "/golden-hour", description: "Lost ₹4.2 lakh to a WhatsApp investment group; the payment trail is still moving.",
    caseHistory: [
  ...
  {
    id: "citizen-arjun", firstName: "Arjun", name: "Arjun Nair", age: 28, language: "en", persona: "case-builder", email: "arjun@demo.in", password: "demo1234", accessCode: "arjun@demo.in / demo1234", destination: "/report", description: "Lost ₹18,000 after a fake electricity-bill call; building the complaint in his own words.",
    caseHistory: [
