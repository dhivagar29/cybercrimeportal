...
import { CircleDollarSign, FileText, Home, Search, ShieldCheck, TextCursorInput } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="bg-[#e45118] px-3 py-2 text-center text-xs font-black tracking-wide text-white">
        Independent hackathon prototype — mock data. Not connected to police, banks, 1930, or NCRP.
      </div>
